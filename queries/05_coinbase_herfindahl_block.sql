...
`project_name.bitcoin.herf_coinbase_output` AS
...
CREATE TABLE IF NOT EXISTS
`project_name.bitcoin.herf_coinbase_tx` AS
SELECT
...
CREATE TABLE IF NOT EXISTS
`project_name.bitcoin.herf_coinbase_txo_flow` AS
...
FROM
  `project_name.bitcoin.herf_coinbase_output` AS coinbase_output

LEFT JOIN
  `project_name.bitcoin.herf_coinbase_tx` AS tx1
ON
...
CREATE TABLE IF NOT EXISTS
`project_name.bitcoin.herf_coinbase_txos` AS
...
FROM
  `project_name.bitcoin.herf_coinbase_txo_flow`
;

CREATE TABLE IF NOT EXISTS
`project_name.bitcoin.herf_coinbase_herf` AS
...
FROM
  `project_name.bitcoin.herf_coinbase_txos`
JOIN
(SELECT
  coinbase_tx_hash,
...
CREATE TABLE IF NOT EXISTS
`project_name.bitcoin.herf_block` AS
...
SELECT
  ...
  coinbase_block_ts,
  SUM(row_contribution) AS coinbase_total_value,
  SUM(row_herf) AS herfindahl_index
FROM
  `project_name.bitcoin.herf_coinbase_herf`
GROUP BY
  coinbase_tx_hash,
  coinbase_block_number,
  coinbase_block_ts
...
DROP TABLE IF EXISTS `project_name.bitcoin.herf_coinbase_output`;
DROP TABLE IF EXISTS `project_name.bitcoin.herf_coinbase_tx`;
DROP TABLE IF EXISTS `project_name.bitcoin.herf_coinbase_txo_flow`;
DROP TABLE IF EXISTS `project_name.bitcoin.herf_coinbase_txos`;
DROP TABLE IF EXISTS `project_name.bitcoin.herf_coinbase_herf`;